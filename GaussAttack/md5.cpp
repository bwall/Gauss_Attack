...
void MD5::finalize(int iterations)
{
...
void MD5::transform_i(int count)
{
	for(int i = 0; i < count; i++)
	{
		register uint4 a = 0x67452301, b = 0xefcdab89, c = 0x98badcfe, d = 0x10325476;

		/* Round 1 */
		FF (a, b, c, d, state[ 0], S11, 0xd76aa478); /* 1 */
		FF (d, a, b, c, state[ 1], S12, 0xe8c7b756); /* 2 */
		FF (c, d, a, b, state[ 2], S13, 0x242070db); /* 3 */
		FF (b, c, d, a, state[ 3], S14, 0xc1bdceee); /* 4 */
		FF (a, b, c, d, 128, S11, 0xf57c0faf); /* 5 */
